...
str +='ceil() : ' + Math.floor(su3) + 'br/>';
str +='ceil() : ' + Math.floor(su4) + 'br/>';
...
str +='random()' + (parseInt(Math.random()*10)+1) + 'br/>'; // 0~1사이의 실수형 난수
str +='random()' + (parseInt(Math.random()*(10)-5+1)+5) + 'br/>'; // 5~10사이의 실수형 난수
demo.innerHTML = str;